...
?>
        <div class='col-4 shadow-lg m-1 p-4 rounded '>
                <ul class="nav nav-tabs ">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="index.php?action=encours">En cours</a>
                    </li>
            ...
            <div class="moteurRecherche">
                <h4  class="text-center my-5" id="text_RC">Rechercher une commande</h4>
