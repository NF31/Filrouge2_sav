...
?>
       ...
       <div class='col-8 shadow-lg ms-2 py-3 rounded  style="max-height: 100vh"'>
       <h4 class="p-3 text-center" >Résultat des commandes en cours </h4>
        ...
        <!-- Fermeture du buffer -->
   <?php     $affichResEnCours = ob_get_clean() ?>