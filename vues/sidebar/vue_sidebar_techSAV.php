...
<div class="d-flex justify-content-around p-2 m-3">
    <div class="col-4 shadow-sm m-1 p-4 rounded">
        <ul class="nav nav-tabs">
            <li class="nav-item ">
                <a class="nav-link" aria-current="page" href="index_admin.php?action=listTechsALL">TECH ALL</a>
            </li>
            <li class="nav-item active">
                <a class="nav-link" href="index_admin.php?action=listTechsSAV">TECH SAV</a>
            </li>
            <li class="nav-item ">
                <a class="nav-link" href="index_admin.php?action=listTechsHOLTLINE">TECH HOTLINES</a>
            </li>
        </ul>
        <div class="moteurRecherche">
            <h4 class="text-center my-5">Créer un technicien SAV</h4>
            <form class="px-3 d-flex flex-column" action="index_admin.php" method="GET">
